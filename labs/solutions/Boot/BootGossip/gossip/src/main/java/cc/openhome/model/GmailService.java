    ...
    public void validationLink(Account acct) {
        try {
            String link = String.format(
                ...
                URLEncoder.encode(acct.getEmail(), "UTF-8"), URLEncoder.encode(acct.getPassword(), "UTF-8")
            );
    ...
    public void passwordResetLink(Account acct) {
        try {
            String link = String.format(
                ...
                URLEncoder.encode(acct.getName(), "UTF-8"), 
                URLEncoder.encode(acct.getEmail(), "UTF-8"), 
                URLEncoder.encode(acct.getPassword(), "UTF-8")
            );
